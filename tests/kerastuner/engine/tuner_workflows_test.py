...
def test_objective_formats():
    ...
    obj = kerastuner.engine.oracle._format_objective(
        [kerastuner.Objective("score", "max"), kerastuner.Objective("loss", "min")]
    )
    assert obj == [
    ...
    obj = kerastuner.engine.oracle._format_objective(["accuracy", "loss"])
    assert obj == [
        kerastuner.Objective("accuracy", "max"),
        kerastuner.Objective("loss", "min"),
    ]
