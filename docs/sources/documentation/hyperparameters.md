...
<span style="float:right;">[[source]](https://github.com/keras-team/keras-tuner/blob/master/kerastuner/engine/hyperparameters.py#L445)</span>
...
- __max_value__: Int. Upper limit of range (excluded).
