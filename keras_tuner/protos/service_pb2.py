...
_CREATETRIALRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="keras_tuner.CreateTrialResponse.status",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_CREATETRIALRESPONSE.fields_by_name[
    "status"
].enum_type = keras__tuner_dot_protos_dot_keras__tuner__pb2._ORACLESTATUS
_CREATETRIALRESPONSE.fields_by_name[
    "trial"
